...
هدف اولیه برای پیاده سازی این تسک اجرای همزمان فرانت اند و بک اند بود. بخش فرانت اند در این شاخه و یک برنامه فول استک در شاخه بعدی پیاده سازی بشود. در حال حاضر بخش فرانت اند در این شاخه کامل شده و در شاخه بعدی برنامه فول استک در حال توسعه است.
...
اگر مجددا فرصتی باشد به بهبود رابط کاربری و انیمیشنی کردن ظاهر برنامه میپردازم (در این بخش) و بخش بک اند را کامل میکنم (در شاخه بعدی).
