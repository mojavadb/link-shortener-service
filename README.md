...
هدف اولیه برای پیاده سازی این تسک اجرای همزمان فرانت اند و بک اند بود. بخش فرانت اند در این شاخه و یک برنامه فول استک در شاخه بعدی پیاده سازی بشود. در حال حاضر بخش فرانت اند کامل شده در این شاخه و در شاخه بعدی برنامه فول استک در حال توسعه است.
