...
در این شاخه تسک های فرانت اند (اختیاری و اجباری به جز تسک مربوط به تست نویسی) رو کامل کردم.
اگر فرصت کنم تسک های مربوط به بک اند رو در یک برنچ جدید انجام میدهم و با فرانت اند ترکیب می کنم تا برنامه به صورت فول استک پیاده سازی شده باشد.
